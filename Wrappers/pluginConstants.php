...
class pluginConstants{
    ...
    const notice_message = 'mo_azos_notice_message';
    const HOSTNAME = "https://login.xecurify.com";
    const PLUGIN_ACTIVATED = 'mo_azos_plugin_activated';
    const YOUTUBE_GUIDE_LINK = 'https://www.youtube.com/embed/UbeDfR1TOH0';
    const azos_auth_code = "mo_azos_auth_code";
    const azos_refresh_token = "mo_azos_refresh_token";
    const CID = 'NTEzY2Q3NTYtOGMyZC00ZjVkLTk5ZTctMWFhY2NiMzY5MDk0';
    const CSEC = 'YnNNOFF+Nm0zQUtiTEsxU01rNmNsM3JVUXZSa3oyZlBOYk1nWGRhQg==';
    const CONNECT_SERVER_URI = 'aHR0cHM6Ly9jb25uZWN0LnhlY3VyaWZ5LmNvbS8=';
